...
compare_config="$repo_root/configs/compare_models_real_dev.json"
prompt_config="$repo_root/configs/compare_prompts_real_dev.json"
retrieval_core_config="$repo_root/configs/compare_retrieval_real_dev.json"
retrieval_feature_config="$repo_root/configs/compare_retrieval_modes_real_dev.json"
optimize_config="$repo_root/configs/optimize_real_overnight.json"
compare_run_name="${session_id}_compare_models_real_dev_${safe_label}"
prompt_run_name="${session_id}_compare_prompts_real_dev_${safe_label}"
retrieval_core_run_name="${session_id}_compare_retrieval_real_dev_${safe_label}"
retrieval_feature_run_name="${session_id}_compare_retrieval_modes_real_dev_${safe_label}"
optimize_run_name="${session_id}_optimize_real_overnight_${safe_label}"
...
prompt_config_materialized="$tmp_dir/compare_prompts_real_dev.json"
retrieval_core_config_materialized="$tmp_dir/compare_retrieval_real_dev.json"
retrieval_feature_config_materialized="$tmp_dir/compare_retrieval_modes_real_dev.json"
optimize_config_materialized="$tmp_dir/optimize_real_overnight.json"
