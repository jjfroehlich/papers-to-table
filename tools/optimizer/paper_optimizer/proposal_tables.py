...
CELL_REVIEW_FIELDS = [
    ...
    "diagnostic_flags",
    "proposal_values_all",
    "proposal_statuses_all",
    "proposal_evidence_status_all",
...
def _proposal_row(context: dict[str, Any], proposal: dict[str, Any], source_path: Path, app_run_path: Path) -> dict[str, Any]:
    ...
    return {
        **context,
        ...
        "review_bucket": proposal.get("review_bucket"),
...
def _scored_cell_row(context: dict[str, Any], cell: dict[str, Any], source_path: Path, eval_summary_path: str) -> dict[str, Any]:
    return {
        **context,
        ...
        "selected_proposal_status": cell.get("selected_proposal_status"),
...
def _difficulty_rows(scored_rows: list[dict[str, Any]], *, by_candidate: bool) -> list[dict[str, Any]]:
    ...
    for row in scored_rows:
        ...
        if row.get("selected_proposal_status") == "unresolved":
        ...
        review_rows.append(
            {
                **cell,
                ...
                "proposal_statuses_all": [proposal.get("proposal_status") for proposal in proposals],
                "proposal_evidence_status_all": [proposal.get("evidence_status") for proposal in proposals],
