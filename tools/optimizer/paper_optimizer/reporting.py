...
def normalize_candidate_row(row: dict[str, Any], *, primary_metric: str | None = None) -> dict[str, Any]:
    ...
    normalized = {
        ...
        "missing_evidence_count": safe_int(first_present(row, ["missing_evidence_count", "diagnostic.missing_evidence_count"])),
        ...
        "judge_execution_summary": first_present(row, ["judge_execution_summary", "diagnostic.judge_execution_summary"]),
        "evidence_anchor_reason_counts": first_present(row, ["evidence_anchor_reason_counts", "diagnostic.evidence_anchor_reason_counts"]),
        "evidence_anchor_outcome_counts": first_present(row, ["evidence_anchor_outcome_counts", "diagnostic.evidence_anchor_outcome_counts"]),
