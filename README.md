...
**Current status: Batch 1 — Foundation.** The project skeleton, config system, staged runner, and browser UI shell are in place. Parsing, matching, proposal generation, and export are planned for later batches.
