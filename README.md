...
- Persists experiment summaries, candidate records, round summaries, plots, and a self-contained `report.html` for each experiment.
...
- `plots/compare_primary_by_candidate.png`
- `plots/compare_score_status_counts.png`
- `plots/compare_unscored_reasons.png`
- `plots/compare_primary_by_retrieval_top_k.png`
- `plots/compare_judge_a_vs_judge_b.png`
- `plots/compare_dev_vs_holdout.png` when holdout results exist
- `plots/optimize_best_by_round.png`
- `plots/optimize_score_status_counts.png`
...
Optional tie-break acceptance config:
...
"acceptance": {
	...
	"tie_break": {
		...
		"secondary_objectives": [
			{"metric": "evidence_quality", "direction": "max", "min_improvement": 0.0},
			{"metric": "runtime_seconds", "direction": "min", "min_improvement": 5.0}
		]
	}
}
```
