...
### [x] **P0.T57** Parsed-document contract + parser normalization
...
### [x] **P0.T58** Contextualized retrieval text on chunks
...
### [x] **P0.T59** Typed structural chunk generation
...
### [x] **P0.T60** Table-aware parsing artifacts + retrieval units
...
### [x] **P0.T61** Schema-aware retrieval and context hints
...
### [x] **P0.T62** Structured whole-text and memory payloads
...
### [x] **P1.T8** Quality presets + `max_success_mode` alignment
...
### [x] **P1.T9** Review triage and risk reasons
...
### [x] **P1.T10** Parser adapter layer for stronger backends
...
### [x] **P1.T11** Chunk and parser observability artifacts
...
### [x] **P2.T4** Acceptance-informed example banks
...
### [x] **P2.T5** Multi-column and table-heavy regression fixtures
