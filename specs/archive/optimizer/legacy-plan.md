# Archived Optimizer Plan

Archive status: historical, superseded as normative current source, still informative, partially migrated into [../../tools/optimizer.md](../../tools/optimizer.md), [../../architecture/integration.md](../../architecture/integration.md), [../../contracts/optimizer-candidate.md](../../contracts/optimizer-candidate.md), and [../../plan.md](../../plan.md).

Original source path: `tools/optimizer/specs/plan.md`

This file preserves the pre-unification optimizer technical plan in archival form. The legacy content below is preserved verbatim from git history except for this archive header.
