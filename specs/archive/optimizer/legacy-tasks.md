# Archived Optimizer Tasks

Archive status: historical, superseded as canonical task tracker, still informative for implementation history, partially duplicated intentionally in [../../tasks.md](../../tasks.md), whose root tracker is now the canonical owner.

Original source path: `tools/optimizer/specs/tasks.md`

This file preserves the pre-unification optimizer task tracker in archival form. The legacy content below is preserved verbatim from git history except for this archive header.
