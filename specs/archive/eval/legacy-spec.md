...
Archive status: historical, superseded as normative current source, still informative, partially migrated into [../../tools/eval.md](../../tools/eval.md), [../../contracts/run-bundle.md](../../contracts/run-bundle.md), [../../contracts/proposals-and-evidence.md](../../contracts/proposals-and-evidence.md), and [../../contracts/eval-summary.md](../../contracts/eval-summary.md).

Original source path: `tools/eval/specs/spec.md`

This file preserves the pre-unification eval spec in archival form. The legacy content below is preserved verbatim from git history except for this archive header.
