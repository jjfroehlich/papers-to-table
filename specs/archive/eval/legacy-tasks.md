...
Original source path: `tools/eval/specs/tasks.md`

This file preserves the pre-unification eval task tracker in archival form. The legacy content below is preserved verbatim from git history except for this archive header.
