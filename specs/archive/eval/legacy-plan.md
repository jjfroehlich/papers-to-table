...
Archive status: historical, superseded as normative current source, still informative, partially migrated into [../../tools/eval.md](../../tools/eval.md), [../../contracts/run-bundle.md](../../contracts/run-bundle.md), [../../contracts/eval-summary.md](../../contracts/eval-summary.md), and [../../plan.md](../../plan.md).

Original source path: `tools/eval/specs/plan.md`

This file preserves the pre-unification eval technical plan in archival form. The legacy content below is preserved verbatim from git history except for this archive header.
