# Archived Main-App Research

Archive status: historical, superseded as normative current source, still informative, partially migrated into [../../plan.md](../../plan.md) and selected current normative files, but preserved here for rationale, alternatives, and implementation-detail depth.

Original source path: `specs/research.md`

This file preserves the pre-unification main-app research notes in archival form. The legacy content below is preserved verbatim from git history except for this archive header.
