# Archived Main-App Spec

Archive status: historical, superseded as normative current source, still informative, partially migrated into [../../product/overview.md](../../product/overview.md), [../../product/main-app.md](../../product/main-app.md), [../../product/review-workflow.md](../../product/review-workflow.md), [../../contracts/run-bundle.md](../../contracts/run-bundle.md), and [../../contracts/proposals-and-evidence.md](../../contracts/proposals-and-evidence.md).

Original source path: `specs/spec.md`

This file preserves the pre-unification main-app spec in archival form. The legacy content below is preserved verbatim from git history except for this archive header.
