...
| 2026-06-17 | `exp_a2b_typed_scoring_e4b_20260617 / run_20260617_140741_s16g3m` | [Typed Retrieval Scoring (A2b)](#kept-or-partially-kept-ideas) | `google/gemma-4-e4b` | Genome editing | 0.62 | 14.00 min | Merged to main as the default typed scoring context after user decision; still single-replicate evidence. |
...
| 2026-06 | `681e998`, main `4ef46b1` | Typed Retrieval Scoring (A2b) | Kept as default retrieval scoring behavior after user decision. This narrow ablation excludes page-number tokens, keeps reviewer-visible display text unchanged, and adds only chunk-type/section/figure/table markers to retrieval scoring text. The e4b dev-check scored 0.62 versus matched current-main wave-2 baseline 0.58, with evidence quality 0.82 versus 0.78 and runtime 14.00 min versus 9.98 min. Main now defaults `retrieval.typed_scoring_context` to `chunk_type_section_figure_v1`; `none` remains an advanced ablation/off mode. |
...
| `exp/20260617-a2b-typed-retrieval-scoring` | `681e998`, main `4ef46b1` | [Typed Retrieval Scoring (A2b)](#kept-or-partially-kept-ideas) | Narrow typed scoring-text ablation without page-number tokens; merged to main as default typed scoring context. |
