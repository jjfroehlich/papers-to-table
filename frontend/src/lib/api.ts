import type { MatchRecord, ProposalDetail, ProposalRecord, ReviewerSummary, RunRecord, RunSummary } from './types'
...
export const api = {
  ...
  downloadAsset: (runId: string, kind: 'workbook' | 'audit-log' | 'run-summary' | 'reviewer-summary') => `${API_ROOT}/runs/${runId}/downloads/${kind}`,
}
